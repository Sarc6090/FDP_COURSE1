//Programa 7: Switch-Case de Figuras eometricas
...
int main(){
    ...
    switch (choice) {
        ...
        case 3:
            ...
            printf("\nEl valor del area del rectangulo con lados de valor %.0f y %.0f es: %.2f.", leg1, leg2, triangle_area);				//Mostrando en pantalla el resultado
