...
int main()
{
	...
	scanf(" %c", &choice);																//Tomando la desicion si se quiere añadir un numero mas a comparar 
	
	if (choice == 's') {
	
    	printf("Introduce el cuarto numero: ");
    	scanf(" %d", &num4);															//Escaneando desde teclado en la variable 'num4' en caso de que la decision anterior sea positiva
    }
